...
export default {
  ...
  putItem: function (table_name: string, item: any) {
    let params = {
      TableName: table_name,
      Item: item
    };
  ...
  putItems: function (table_name: string, items: object[]) {
    let params = {
      RequestItems: {}
    };
    let promise = Promise.resolve();
  ...
  deleteItem: function (table_name: string, id: string) {
    let params = {
      TableName: table_name,
      Key: {},
  ...
  deleteItems: function (table_name: string, ids: Array<string>) {
    let params = {
      RequestItems: {}
    };
    let promise = Promise.resolve();
